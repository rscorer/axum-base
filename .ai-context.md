...
**Axum Base** is a production-ready, modular Rust web server template designed to serve as a robust foundation for building secure, scalable web applications. This project demonstrates modern Rust web development best practices using the Axum 0.7 framework, with comprehensive authentication, database integration, templating, and testing capabilities.
...
### Integration Testing
- **HTTP Endpoint Testing**: Use `axum-test` for end-to-end API testing
...
### Test Organization
- Unit tests colocated with source code using `#[cfg(test)]`
- Integration tests in dedicated `tests/` directory
- Helper functions and test utilities shared across test modules
- Database setup and teardown for consistent test environments
